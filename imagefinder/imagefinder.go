...
// type ImageBox struct {
// 	Base64 string // image content as base64
// 	X, Y   int64
// 	Cx, Cy int64
// 	Path   string // original embed ID for reference
// }
...
// 					// Find actual image in zip
// 					for _, f := range r.File {
// 						if strings.HasSuffix(f.Name, embed) || strings.Contains(f.Name, embed) {
// 							rc, _ := f.Open()
...
// // 						continue
// // 					}
// // 					imgData, err := readFileFromZip(r, filepath.ToSlash("ppt/"+target))
// // 					if err != nil {
// // 						continue
// // 					}
// // 					b64 := base64.StdEncoding.EncodeToString(imgData)
...
// // 		case xml.EndElement:
// // 			// nothing to do, keep your original stack logic if needed
// // 		}
// // 	}
